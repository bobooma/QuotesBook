...
//                           textStyle: layerItem["style"],
//                           textAlingment: layerItem["align"],
//                           minFontSize: 10,
//                           onEditCompleted: (style, align, text) {
//                             setState(() {
//                               layers[layers.indexOf(layerItem)]['value'] = text;
//                               layers[layers.indexOf(layerItem)]['style'] =
//                                   style;
//                               layers[layers.indexOf(layerItem)]['align'] =
//                                   align;
//                             });
//                             // setState(() {
//                             //   text1 = text;
...
//             // _tapHandler(
//             //     layerItem["value"], layerItem["style"], layerItem["align"]);
//             // setState(() {
//             //   layers[layers.indexOf(layerItem)]['value'] = text1;
//             //   layers[layers.indexOf(layerItem)]['style'] = textStyle1;
//             //   layers[layers.indexOf(layerItem)]['align'] = textAlign;
//             // });
//             // setState(() {});
